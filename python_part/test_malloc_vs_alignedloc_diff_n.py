...
for threadCount in THREAD_COUNTS:
    ...
    timings = run_sort_program('../problem_3_aligned', BITS_TO_TEST, [MAXIMUM_N_SEQ, MAXIMUM_N_SEQ * 2, MAXIMUM_N_SEQ * 3], MAX_SECONDS,
    ...
    timings = run_sort_program('../problem_3_malloc', BITS_TO_TEST, [MAXIMUM_N_SEQ, MAXIMUM_N_SEQ * 2, MAXIMUM_N_SEQ * 3], MAX_SECONDS,
                           customEnv={'OMP_NUM_THREADS': str(threadCount)})
